<?php
// @lambo-welcome v6 — DO NOT edit this marker line; Lambo PHP looks
...
<title>Lambo PHP Dashboard</title>
<style>
:root {
...
<header class="topbar">
    <a href="/" class="logo">
        <img src="/assets/lambo.png" alt="" onerror="this.style.display='none'">
    ...
    <div class="right">
        ...
        <a href="https://github.com/flessan/lambophp" target="_blank" rel="noopener">GitHub</a>
    </div>
</header>
...
<div class="layout">
    <aside class="sidebar">
        <h4>Dashboard</h4>
        <nav>
            <a href="#welcome" class="active"><img src="/assets/lambo.png" alt="">Welcome</a>
    ...
    <main class="main">
        <h1 class="page-title" id="welcome">Welcome to Lambo PHP</h1>
        ...
        <section class="panel" id="projects">
            ...
            <div class="panel-body">
                <?php if (empty($projects)): ?>
                    <p class="empty">No projects yet. Open the Lambo PHP control panel → <strong>Projects</strong> tab → pick a framework → Create.</p>
                <?php else: ?>
                    <div class="projects">
        ...
        <section class="panel" id="docs">
            ...
            <div class="panel-body">
                <div class="docs">
                    <a href="https://github.com/flessan/lambophp" target="_blank" rel="noopener">
                        <strong>Lambo PHP on GitHub</strong>
...
<footer>
    <span>Lambo PHP · serving from <?= htmlspecialchars($document_root) ?></span>
